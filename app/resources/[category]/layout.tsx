...
export default function CategoryLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      {/* HEADER */}
      <header className="flex flex-wrap lg:justify-start lg:flex-nowrap w-full">
        <nav className="w-full h-20 flex flex-wrap lg:grid lg:grid-cols-12 basis-full items-center px-4 md:px-6 lg:px-8 mx-auto bg-white/30 backdrop-blur-md border-b border-white/20 shadow-sm">
      ...
      <main className="flex-1">
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link
            href="/resources"
            className="inline-flex items-center gap-x-2 text-sm font-medium text-blue-600 hover:text-blue-800 dark:text-blue-500 dark:hover:text-blue-400"
          >
            <svg
              className="size-4"
              xmlns="http://www.w3.org/2000/svg"
